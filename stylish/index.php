<?php
    ...
    include_once("includes/navs.php");
...
<!-- quick view -->
<?php
    require_once("includes/quick-view.php");    
?>

<!-- cart view -->
<?php
    require_once("includes/cart-view.php"); 
?>
        ...
        <div class="swiper-wrapper">
          <div class="swiper-slide">
            <div class="card d-flex flex-row align-items-end border-0 large jarallax-keep-img">
              ...
              <?php echo showMainImages($conn, 1); ?>
            ...
            <div class="row g-4">
              <div class="col-lg-12 mb-4">
                <div class="card d-flex flex-row align-items-end border-0 jarallax-keep-img">
                  ...
                  <?php echo showMainImages($conn, 2); ?>
              ...
              <div class="col-lg-12">
                <div class="card d-flex flex-row align-items-end border-0 jarallax-keep-img">
                  ...
                  <?php echo showMainImages($conn, 3); ?>
          ...
          <div class="swiper-slide">
            <div class="card d-flex flex-row align-items-end border-0 large jarallax-keep-img">
              ...
              <?php echo showMainImages($conn, 4); ?>
            ...
            <div class="row g-4">
              <div class="col-lg-12 mb-4">
                <div class="card d-flex flex-row align-items-end border-0 jarallax-keep-img">
                  ...
                  <?php echo showMainImages($conn, 5); ?>
